...
## Project Structure
    ...
    ├── ideapros_llc_passag_30831  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_passag_30831`
...
2. Clone this repo and `cd ideapros_llc_passag_30831`
